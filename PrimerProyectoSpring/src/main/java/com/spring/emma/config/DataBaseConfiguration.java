...
@Configuration //es para trabajar un bean , una interfaz , que puede tener muchos comportamientos
@EnableTransactionManagement //nos ayuda en la aprte de transacciones en BD
public class DataBaseConfiguration {
	
	@Bean // nos va a decir el comportamiento tiene el objeto  y contra quien se va a  instanciar
